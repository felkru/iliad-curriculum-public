...
summary: A practical tour of alignment methods used at each stage of frontier
  LLM development — pre-training, post-training, and three phases of deployment.
learningOutcomes:
  - Name the main stages of LLM development — pre-training, post-training, and
    deployment — and understand what allowances each stage gives us with regards
    to model safety.
  - Name the main alignment methods used in each phase.
  - Intuitively understand the throughlines that connect the methods within each
    phase.
