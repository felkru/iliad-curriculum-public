...
teachingGuide: >
  ...
  pairs.
internalNotes: >
  - Theory Workshop material produced by Leon Lang (Iliad) and David Quarel
...
-   [Sutton & Barto](https://www.andrew.cmu.edu/course/10-703/textbook/BartoSutton.pdf): Chapter 3 (3.1–3.6), Chapter 4 (4.1–4.4), Chapter 6 (6.1, 6.3 — especially Example 6.4). Note that Section 6.1 talks about TD updates for the value function ; we will instead be using TD updates for the Q-value . Don't worry about the references to Monte Carlo in Chapter 5.
