...
teachingGuide: |-
  ...
  * 1 hour of lecture by Cole Wyeth on [reflective oracles and nonrealizability](/uploads/agent-foundations/Arrow_of_time_presentation.pdf)  
  * 1 hour of exercises on [Lob’s theorem, complete class and information theory](/uploads/agent-foundations/Agency_exercise_V2.pdf)  
  * 1 hour of lecture by Aram Ebtekar on [decision theory](/uploads/agent-foundations/Arrow_of_time_presentation.pdf)
...
Start with the [lecture slides](/uploads/agent-foundations/Agency_slides.pdf) which give a bird's eye view of the agent foundations landscape and what the key open problems are. Then continue with the following fundamental readings:
...
Next, do the [agency exercises](/uploads/agent-foundations/Agency_exercise_V2.pdf).
...
-   [Introduction to Lob’s theorem](/uploads/agent-foundations/lob-notes-IAFF.pdf) - Read up to and including section 3
...
-   [Logical induction paper](/uploads/agent-foundations/1609.03543v5.pdf) - Read Chapters 1 and 3, Skim Chapter 4
...
-   [Function decision theory](/uploads/agent-foundations/1710.05060v2.pdf)\- Read Chapter 1-5
...
-   [Embedded AIXI slides](/uploads/agent-foundations/Embedded_AIXI.pdf): Guest lecture by Cole Wyeth
    
-   [Decision theory slides](/uploads/agent-foundations/Arrow_of_time_presentation.pdf): Guest lecture by Aram Ebtekar
...
-   [Tiling agent](/uploads/agent-foundations/TilingAgentsDraft.pdf)
    
-   [Admissibility and complete class](/uploads/agent-foundations/admiss.pdf)
    
-   [Dutch book argument](/uploads/agent-foundations/dutchdef.pdf)
    
-   [Limit computable grains of truth](/uploads/agent-foundations/2508.16245v1.pdf)
    
-   [Embeddedness Failures in Universal Artificial Intelligence](/uploads/agent-foundations/2505.17882v1.pdf)
    
-   [Value under ignorance](/uploads/agent-foundations/2512.17086v2.pdf)
