...
-   The introductory lecture in world models was done following the content within these rough [notes](https://drive.google.com/file/d/12UzgFkMN2bpu8U50vB5tAHxVdCpKdr3f/view?usp=drive_link). The session used [these slides](https://drive.google.com/file/d/1Rtfc5uW0oTDJBx7IEkJlmgLR1KOcg_4Z/view?usp=drive_link).
...
-   The last session on abstractions in world models used [these slides](https://drive.google.com/file/d/11LyzmBFRoovylkOPPzMNuG2olPwG-y9P/view?usp=drive_link), which are closely related to this [preprint](https://arxiv.org/abs/2512.00984).
