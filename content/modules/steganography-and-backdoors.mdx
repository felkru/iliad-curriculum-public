...
summary: Hidden communication in LLM outputs — perfect vs computational
  steganography, a practical PRF-based scheme, and relations with
  chain-of-thought monitoring; furthermore, hidden backdoors.
learningOutcomes:
...
teachingGuide: "
  ...
  paraphrasing](/uploads/steganography-and-backdoors/2410.03768v2.pdf) [Model
  weight extractions](/uploads/steganography-and-backdoors/2511.02620v3.pdf)
  Discussion Prompts for the papers: Why is this scenario a danger to AI safety?
  What are sender, receiver, adversary? What is the channel used How was the
  secret key exchanged? Is the steganography successful? How does it emerge?
  Give a small example of a possible stego-text and payload |
  ...
  Backdoors](/uploads/steganography-and-backdoors/2204.06974v2.pdf)**
  [\"Backdoor Defense, Learnability and
  Obfuscation\"](https://arxiv.org/abs/2409.03077) (Pau Christiano) [\"Injecting
  Undetectable Backdoors in Obfuscated Neural Networks and Language
  Models\"](https://arxiv.org/abs/2406.05660) Explaining the papers to each
  other What are the limitations of the current approaches? How does this relate
  to the worst-case interp stuff from module E.3? What is the advantage of their
  backdoor in Section 4.2 compared to Section 4.1? What are the properties we
  would like to have for a good backdoor?  **[Cryptographic
  Backdoors](/uploads/steganography-and-backdoors/2204.06974v2.pdf)**  |

  | 15:00 | **Exercise**: Construction of the Random ReLU two-layer network from
  Based on the paper: [**Shafi
  Goldwasser**](/uploads/steganography-and-backdoors/2204.06974v2.pdf) et al.
  Calculate that this will work as intended, also there is a slight mistake in
  the paper that is fixed with this exercise. Potentially ask the students why
  the version in the paper won’t work as intended (Answer: It’s that there is no
  normalisation of the input vector, so just making the norm larger is already a
  backdoor). The exercise is broken down into intermediate steps that are simple
  enough for the students to go
...
This is a test. Does it work now? Why doesn't it auto update as I type LOL?

<Exercise difficulty={1}>
  Testing the exercise component $\text\{pretty tex\} = 100\%$

  <Callout type="note">
    oh that's actually possible to do nested. that's cool!
  </Callout>
</Exercise>
...
-   Models can collude with each other for nefarious purposes and scheme without human overseers noticing. [Steganography can arise and not easily prevented by paraphrasing](/uploads/steganography-and-backdoors/2410.03768v2.pdf)
-   Crucial information could be smuggled out of frontier labs, such as model weights ([Model weight extractions](/uploads/steganography-and-backdoors/2511.02620v3.pdf)) which allows either bad actors to run strong models, the model to proliferate copies of itself to run independently.
