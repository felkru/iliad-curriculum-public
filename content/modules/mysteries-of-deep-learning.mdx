...
learningOutcomes:
  - Students can explain how the three barriers from Day B.1 (approximation,
    generalization, optimization) manifest specifically in the context of deep
    learning, and why classical theoretical frameworks (e.g. bias-variance
    tradeoff, universal approximation) actively counterpredicted deep learning's
    success
