---
title: "A.1: AI Alignment — An Introduction"
cluster: "A"
difficulty: 2
importance: 5
timeMinutes: 240
contributors: ["Leon Lang"]
summary: "Introduction to AI alignment: what alignment means, decomposition of risks, alignment targets, scheming, and inner vs outer alignment."
learningOutcomes: ["understand the basic decomposition of risks into AI misalignment, misuse, power grabs, and others","can explain different alignment targets like coherent extrapolated volition, intent alignment, or AI that follows a constitution","can reason about training stories and outer and inner (mis)alignment, challenges to these notions, and the relationship to inductive biases","are aware of discussions on whether AI systems develop goals and understand the basic arguments for instrumental convergence","are aware of foundational discussions on the level of risk and different high-level approaches to solving the AI alignment problem"]
---
## Prerequisites
...
- [A love for humanity](https://www.snexplores.org/article/artificial-intelligence-ai-safety-good-behavior): "Scott Aaronson says OpenAI's cofounder, Ilya Sutskever, has asked him how to use math to define what it means for AI to love humanity. Right now, he has no idea how to answer that. But he sees it as a 'North Star,' or leading goal."
...
- [Risks from Learned Optimization](https://arxiv.org/abs/1906.01820) is the general conceptual problem of ensuring that the trained AI agent ends up internally optimizing for the goals given to them during training — also called the *inner alignment problem*. We come to this work again in the section on agent foundations, but it can already be appreciated in this introduction.
...
- [Chapter 8 in Superintelligence — "Is the default outcome doom?"](https://repo.darmajaya.ac.id/5339/1/Superintelligence_%20Paths%2C%20Dangers%2C%20Strategies%20%28%20PDFDrive%20%29.pdf)
...
- [Coherent extrapolated volition](https://intelligence.org/files/CEV.pdf): Read the 2.5 intro pages in Section 3.
...
- [Inductive biases](https://www.cs.cmu.edu/~tom/pubs/NeedForBias_1980.pdf): Read ~entirely.
...
- [Basic AI drives](https://selfawaresystems.com/wp-content/uploads/2008/01/ai_drives_final.pdf): Read at least abstract, intro, conclusion, and understand every heading and a basic argument for its underlying AI drive.
...
<Callout type="note">
The following are internal notes from the module author about possible future improvements.
</Callout>
...
- Other:
  - "especially if the AI is additionally smart or powerful": This module does not talk much about the intelligence of AI and how this influences the risk landscape! Is this an oversight?
  - On "Learn more":
  ...
  - Maybe more generally: Does this document have too many doublings and boilerplate? Should it be simplified? Is there a difference between what should be shared with participants vs. externally?
