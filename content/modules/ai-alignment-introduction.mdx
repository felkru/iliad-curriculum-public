...
summary: "An opinionated tour of the AI alignment problem: alignment targets,
  problem decompositions (outer/inner alignment, training stories, inductive
  biases), goal-directedness and instrumental convergence, the risk landscape,
  and high-level solution approaches."
learningOutcomes:
