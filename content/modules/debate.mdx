...
teachingGuide: >
  ...
  - **10:00** Fun exercise 'Wrong but convincing proofs' (`Wrong_Proofs.pdf`,
  Google Drive `16jEJXkg5F590kHyvTzub5zV5A51RrZE5`). A series of wrong proofs is
  presented and students find the mistake. They basically take the role of 'Bob'
  who points out the flaws in Alice's proofs.

  - **10:30** In-depth explanation of the main formalisms of debate and
  cross-examination including formal definition, proof sketches for the
  hardness-reduction for PSPACE and NEXP respectively (sketched at the
  whiteboard with computation table of a Turing machine), and a few exercises.
  Based on `Debate_Proofs_and_Exercises.pdf`.

  - **12:30** Lunch Break.

  - **13:30** Splitting the group into 3 to read some critiques of AI safety via
  debate: Critique by Marius Hobbhahn with replies by Rohin Shah; Critique by
  Michael Cohen with replies by Paul Christiano; Obfuscated Arguments by Beth
  Barnes. Include also the discussion in the comments under the posts! Guided
  Discussion: What have people criticised about AISvD? Which criticisms are
  sustained and which have been conceded? Which do you think are the strongest?

  - **14:30** Pause.

  - **15:30** Reading session: The AI safety case of the AISI
  ([arxiv.org/pdf/2505.03989](https://arxiv.org/pdf/2505.03989)) as preparation
  for the later talk. The goal is that the students can follow the talk and
  already ask questions while it is given.
...
Debate is a form of scalable oversight: it seeks to extend a reward signal for honest solutions to difficult problems while reducing the amount of human judgment needed by an exponential factor.
