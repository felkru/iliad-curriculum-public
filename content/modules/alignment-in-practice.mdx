...
teachingGuide: >
  ...
  *Block 2: Constitutional AI and emergent misalignment.* Remind students that
  ...
  => evil" persona to rather have a "gets asked for unsafe code => writes unsafe
  code => helpful" persona. Then ask: can we use this persona-shaping
  ...
  **Presentation (20 min).** Walk through the content section. This module is
  ...
  ### Design Challenge: Red-Blue debate
  ...
  *how much adversarial effort the system withstood before breaking*. Name this
  as the central idea of the module: safety claims are effort-bounded
